...
table td{text-align:center;padding:10px;font-size:20px;}
		...
		<body>
				...
				?>
				<tr><td colspan="6" style="text-align:right;border-top:1px solid #400040;"><b style="color:red;font-size:25px;">Total</b></td><td style="border-top:1px solid #400040;border-bottom:1px solid #400040;">Tk.  <?php echo"".$b."";?></td></tr>
				</table>
